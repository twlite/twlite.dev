...
I could spend an entire week working on production software, get paid for it, and feel satisfied that I'd done my job well.

Then I'd spend an entire weekend building some random side project that nobody asked for, publish it for free, wake up to find a few people actually using it, and somehow feel happier than I did all week.
